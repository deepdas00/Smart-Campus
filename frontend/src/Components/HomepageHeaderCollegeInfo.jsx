...
export default function CollegeInfo({ collegeData }) {
  ...
  const data = collegeData || {
    ...
    address: "Knowledge Park, Sector V, New Delhi",
    NAAC: "A++",
    officialEmail: "admin@xyzinstitute.edu",
    contactNumber: "+91 98765 43210",
    principalName: "Dr. Robert J. Williams",
    description: "A beacon of innovation, dedicated to shaping tomorrow's leaders through cutting-edge research, holistic development, and a vibrant academic ecosystem.",
    departmentName: ["Computer Science", "Electronics", "Mechanical"],
    logo: null
  };
  ...
  return (
    <section className="relative min-h-[600px] flex items-center overflow-hidden bg-white">
      ...
      <div className="relative max-w-7xl mx-auto px-8 py-16 lg:py-24 w-full">
          ...
          <div className="space-y-10 animate-in slide-in-from-left-8 duration-1000">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-slate-500 font-medium max-w-xl leading-relaxed">
                {data.description || "Streamlining campus operations with real-time digital access. Students and staff can now access resources efficiently."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-4 p-5 bg-white border border-slate-100 shadow-sm rounded-[2rem] hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-800 line-clamp-1">{data.address}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-5 bg-white border border-slate-100 shadow-sm rounded-[2rem] hover:shadow-md transition-all">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-800">{data.contactNumber}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-slate-900 rounded-[3.5rem] p-10 text-white text-center overflow-hidden">
                ...
                <div className="mx-auto w-24 h-24 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform duration-500">
                  {data.logo ? (
                    ...
                    <GraduationCap size={48} className="text-white opacity-80" strokeWidth={1} />
                  )}
                </div>

                <div className="space-y-2">
                  <h3 className="text-2xl font-bold tracking-tight">Academic Hub</h3>
                ...
                <div className="mt-8 p-4 bg-white/5 rounded-2xl border border-white/10 text-left">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-white">{data.principalName}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-2">
                  {data.departmentName.slice(0, 3).map((dept, idx) => (
                    <span key={idx} className="px-3 py-1 bg-white/10 rounded-full text-[10px] font-bold text-slate-300 border border-white/5">
                      {dept}
                    </span>
                  ))}
                </div>
