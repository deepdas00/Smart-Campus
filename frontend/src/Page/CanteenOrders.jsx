                    ...
                    <div className="p-4 flex flex-col md:flex-row items-center justify-between gap-6">
                      ...
                      <div className="flex items-center gap-5 w-full md:w-auto">
                        ...
                        <div>
                          <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                            ...
                            <span
                              className={`text-[10px] px-2 py-0.5 rounded-md border font-bold uppercase tracking-tighter ${
                                order.orderStatus === "served"
                                  ? "bug-green-50 text-green-600 border-green-100"
                      ...
                      <div className="flex flex-wrap gap-2 flex-1 justify-start md:justify-center">
                        {order.items.slice(0, 2).map((item, i) => (
                          <span
                            key={i}
                            className="px-3 py-1.5 bg-slate-50 rounded-xl text-xs font-semibold text-slate-600 border border-slate-100"
                          >
                            {item.name}{" "}
...
/>
            ...
            <div 
            className={
              selectedOrder.orderStatus === "order_received" ? "text-center shrink-0" : "pt-8 px-8 pb-4 text-center shrink-0"}>
            ...
            <div className=  {
              selectedOrder.orderStatus === "order_received" ? "p-8 py-3 bg-slate-50/50 border-t border-slate-100 rounded-b-[2.5rem] shrink-0" : "p-8 py-3 bg-slate-50/50 border-t border-slate-100 rounded-b-[2.5rem] shrink-0"}>
              <div className=  {
              selectedOrder.orderStatus === "order_received" ? "space-y-2 mb-2" : "space-y-2 mb-6"}>
