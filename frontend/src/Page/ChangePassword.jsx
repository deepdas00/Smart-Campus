...
export default function ChangePassword() {
  ...
  <header className="bg-white/80 backdrop-blur-md border-b border-gray-200 fixed w-full z-[100]">
    <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
      <Link to="/" className="flex items-center space-x-2">
        <img
          src={logo}
          className="w-10 h-10 lg:w-13.5 lg:h-13.5 rounded-full bg-white/60 shadow"
        />
        <span className="text-lg lg:text-xl font-bold bg-blue-700 bg-clip-text text-transparent">
          Smart Campus
        </span>
      </Link>
      ...
      <Link
        to="/profile"
        className="px-3 py-1.5 text-sm lg:text-base text-blue-600 hover:bg-blue-50 rounded-lg font-medium"
      >
        Cancel
      </Link>
    </div>
  ...
  <div className="grid lg:grid-cols-2 pt-16 min-h-screen">
    ...
    {/* RIGHT FORM */}
    <div className="flex items-center justify-center px-4 py-10 lg:p-8">
      <motion.div
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8 lg:mb-10">
          <div className="w-14 h-14 lg:w-16 lg:h-16 bg-blue-50 rounded-2xl lg:rounded-3xl flex items-center justify-center mb-4">
            <ShieldCheck className="w-7 h-7 lg:w-8 lg:h-8 text-blue-600" />
          </div>
        ...
        {step === 1 && (
          <div className="space-y-4">
            <label className="block text-[9px] lg:text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">
              Current Password
            </label>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 lg:py-4 bg-slate-50 border rounded-2xl focus:ring-4 focus:ring-blue-500/10 font-bold text-sm"
                placeholder="••••••••"
              />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 lg:py-4 bg-blue-700 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-blue-800 shadow"
            >
              {loading ? (
        ...
        {step === 2 && (
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="text-[9px] lg:text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1">
                New Password
              </label>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-11 pr-12 py-3.5 lg:py-4 bg-slate-50 border rounded-2xl font-bold text-sm"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-11 pr-4 py-3.5 lg:py-4 bg-slate-50 border rounded-2xl font-bold text-sm"
