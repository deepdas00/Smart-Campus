...
import {
  Camera, Coffee, BookOpen, User, ShoppingBag,
  AlertTriangle, Bell, Sparkles, Trophy, Cpu,
  ...
  `}} />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-16 gap-8">
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600/70">Intelligence Dashboard</span>
              </div>
            ...
            <div className="bg-white/70 backdrop-blur-md p-4 pr-8 rounded-2xl border border-white shadow-xl shadow-blue-900/5 flex items-center gap-4 hover:bg-white transition-colors">
              ...
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">Campus Connectivity</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 items-stretch">
            {[
              { icon: Coffee, title: "Digital Canteen", color: "orange-500", desc: "Order meals and track real-time queue status easily.", style: "stagger-1" },
              { icon: BookOpen, title: "Digital Library", color: "blue-600", desc: "Book study cabins and access digital library resources.", style: "stagger-2" },
              { icon: User, title: "My Profile", color: "slate-900", desc: "Manage your academic ID and track your credit progress.", style: "stagger-3" }
            ].map((tile, idx) => (
              <div key={idx} className={`group relative bg-white p-10 rounded-[3rem] shadow-sm border border-slate-100 hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 cursor-pointer overflow-hidden flex flex-col ${tile.style}`}>

                {/* THE TOP HOVER LINE - FIXED OVERFLOW */}
                <div className={`absolute top-0 left-0 w-full h-2 transition-transform duration-500 scale-x-0 group-hover:scale-x-100`}
                  style={{ backgroundColor: tile.icon === Coffee ? '#f97316' : tile.icon === BookOpen ? '#2563eb' : '#0f172a' }}>
                </div>

                <div className="relative z-10 flex flex-col h-full">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 text-white shadow-xl group-hover:scale-110 transition-transform duration-500`}
                    style={{ backgroundColor: tile.icon === Coffee ? '#f97316' : tile.icon === BookOpen ? '#2563eb' : '#0f172a' }}>
                    <tile.icon size={30} />
                  </div>
                  ...
                  <div className="mt-8 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity"
                    style={{ color: tile.icon === Coffee ? '#f97316' : tile.icon === BookOpen ? '#2563eb' : '#0f172a' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group bg-white p-3 rounded-[2.5rem] shadow-xl shadow-blue-900/5 flex items-center border border-white hover:border-purple-200 transition-all duration-500 cursor-pointer">
              ...
              <div className="px-8 flex-1">
                <h4 className="font-black text-slate-800 text-lg uppercase italic tracking-tighter">Order History</h4>
                <p className="text-slate-400 text-[10px] font-bold tracking-widest mt-1">LATEST UPDATED: 2 MINS AGO</p>
              </div>
            ...
            <div className="group bg-rose-600 p-3 rounded-[2.5rem] shadow-2xl shadow-rose-900/20 flex items-center border border-rose-500 hover:bg-rose-700 transition-all duration-500 cursor-pointer">
              ...
              <div className="px-8 flex-1">
                <h4 className="font-black text-white text-lg uppercase italic tracking-tighter">SOS Hub</h4>
                <p className="text-rose-100 text-[10px] font-bold tracking-widest mt-1 opacity-70">EMERGENCY ASSISTANCE</p>
              </div>
              <div className="pr-8 text-white flex items-center gap-3">
                <Camera size={24} className="opacity-50 group-hover:opacity-100 transition-opacity" />
                <ChevronRight size={28} />
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <span className="px-3 py-1 bg-blue-600 text-white text-[9px] font-black uppercase tracking-[0.2em] rounded-md">Live</span>
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-400">Campus Atmosphere</span>
              </div>
      ...
      <section className="py-24 px-6 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-16 gap-6">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-blue-600 font-black uppercase text-[10px] tracking-[0.4em]">Broadcast Stream</span>
              </div>
            ...
            <div className="hidden md:flex items-center gap-6 bg-slate-50 p-4 rounded-2xl border border-slate-100">
              <div className="text-right">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Scroll Sync</p>
                <p className="text-lg font-black text-blue-600 italic leading-none">{Math.round(scrollProgress)}%</p>
              </div>
          ...
          >
            {notices.map((note) => (
              <div key={note.id} className="min-w-[340px] md:min-w-[440px] snap-center">
                <div className="group relative bg-white p-10 rounded-[3rem] border-2 border-slate-100 hover:border-blue-600 transition-all duration-500 shadow-xl shadow-slate-200/50 hover:shadow-blue-500/10 h-full flex flex-col">
                  ...
                  <div className="absolute top-8 right-10">
                    <span className="text-4xl font-black text-slate-50 italic group-hover:text-blue-50 transition-colors">#{note.id}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 mb-10">
                    ...
                    <div>
                      <span className="text-[10px] font-black uppercase text-blue-600 tracking-widest block">{note.type}</span>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-500 text-sm leading-relaxed font-medium">
                      System synchronization and digital resource updates are now being deployed across the campus cloud.
                    </p>
                  </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-700 via-blue-900 to-black text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-6xl font-black italic uppercase tracking-tighter leading-none">
                Smart <br />
                <span className="text-yellow-300 underline decoration-4 underline-offset-8">Campus.</span>
              </h2>
              <p className="text-blue-100/80 text-lg leading-relaxed mt-8 max-w-lg font-medium">
                Revolutionizing the student experience through seamless integration. We bridge the gap between physical infrastructure and digital efficiency.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/10 hover:bg-white/10 transition-all group">
                <p className="text-4xl font-black mb-1 text-yellow-300 group-hover:scale-110 transition-transform origin-left">50+</p>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-200">Global Partners</p>
              </div>
              <div className="bg-white/5 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-white/10 hover:bg-white/10 transition-all group">
                <p className="text-4xl font-black mb-1 text-yellow-300 group-hover:scale-110 transition-transform origin-left">24/7</p>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-200">Cloud Uptime</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 relative">
            {[
              { icon: Trophy, label: "Hackathons", color: "text-orange-400", shadow: "shadow-orange-500/20", delay: "" },
              { icon: Gamepad2, label: "Events", color: "text-pink-400", shadow: "shadow-pink-500/20", delay: "md:translate-y-12" },
              { icon: Shield, label: "Security", color: "text-blue-400", shadow: "shadow-blue-500/20", delay: "" },
              { icon: Cpu, label: "Digitalized", color: "text-purple-400", shadow: "shadow-purple-500/20", delay: "md:translate-y-12" }
            ].map((item, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className={`mb-6 transform group-hover:scale-125 group-hover:-rotate-12 transition-all duration-500 ${item.color}`}>
