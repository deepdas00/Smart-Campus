            ...
            <div className="text-center md:text-left">
              ...
              <motion.p
                ...
                transition={{
                  duration: 0.8,
                  delay: 0.2,
                  ease: [0.21, 1, 0.36, 1], // Smooth premium easing
                }}
                // Your Original Styles Unchanged
                className="text-[11px] sm:text-lg md:text-xl text-gray-600 mb-5 max-w-xl mx-auto md:mx-0 text-center md:text-left leading-relaxed"
              >
